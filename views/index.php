...
<div id="wrap">
   ...
   <div id="hdr">
      ...
      <div id="hdl">
         ...
         <a href="#" class="hl"><?php print (ROOT );?></a>
      ...
      <!-- Main Menu -->
      <div id="menu">
         <a class="mh" href="<?php print (__DIR__ . '/../index.php'); ?>">Home</a>
   ...
   <div id="cnt">
      ...
      <div id="lcnt">
         ...
         <div class="post">
            ...
            <h1>
               <a href="<?php print ('/index.php?ctrl=News&act=one&id='.$item['id']); ?>"><?php echo $item['title']; ?></a>
            </h1>

            <!-- Post Content -->
            <a class="pic_lnk" href="article.html"><img src="./template/images/post_pic1.jpg" alt="post_pic1" /></a>
...
<div id="foo">
   ...
   <div id="foo_d">
      ...
      <div id="foo_menu">
         ...
         <a href="<?php print (__DIR__ . '/../index.php'); ?>">Home</a><span>.</span>
